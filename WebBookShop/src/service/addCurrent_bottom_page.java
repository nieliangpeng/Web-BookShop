...
/**
 * Servlet implementation class addCurrent_bottom_page
 */
@WebServlet("/addCurrent_bottom_page")
public class addCurrent_bottom_page extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public addCurrent_bottom_page() {
        super();
